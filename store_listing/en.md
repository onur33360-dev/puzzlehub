# SlySwipe — Play Store listesi · English (US) (`en`)
...
**Play Console dil kodu:** `en-US`
**Uygulama içi locale karşılığı:** `en` (locales/en.js)
...
1. **Mağaza metni uygulama içi çeviriden AYRIDIR.** `locales/en.js`
