# SlySwipe — Play Store listesi · 简体中文 (`zh-Hans`)
...
**Play Console dil kodu:** `zh-CN`
**Uygulama içi locale karşılığı:** `zh-Hans` (locales/zh-Hans.js)
...
1. **Mağaza metni uygulama içi çeviriden AYRIDIR.** `locales/zh-Hans.js`
