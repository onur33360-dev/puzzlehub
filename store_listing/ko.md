# SlySwipe — Play Store listesi · 한국어 (`ko`)
...
**Play Console dil kodu:** `ko-KR`
**Uygulama içi locale karşılığı:** `ko` (locales/ko.js)
...
1. **Mağaza metni uygulama içi çeviriden AYRIDIR.** `locales/ko.js`
