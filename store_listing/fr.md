# SlySwipe — Play Store listesi · Français (`fr`)
...
**Play Console dil kodu:** `fr-FR`
**Uygulama içi locale karşılığı:** `fr` (locales/fr.js)
...
1. **Mağaza metni uygulama içi çeviriden AYRIDIR.** `locales/fr.js`
