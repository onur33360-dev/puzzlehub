# SlySwipe — Play Store listesi · हिन्दी (`hi`)
...
**Play Console dil kodu:** `hi-IN`
**Uygulama içi locale karşılığı:** `hi` (locales/hi.js)
...
1. **Mağaza metni uygulama içi çeviriden AYRIDIR.** `locales/hi.js`
