# SlySwipe — Play Store listesi · Português (Brasil) (`pt-BR`)
...
**Play Console dil kodu:** `pt-BR`
**Uygulama içi locale karşılığı:** `pt-BR` (locales/pt-BR.js)
...
1. **Mağaza metni uygulama içi çeviriden AYRIDIR.** `locales/pt-BR.js`
