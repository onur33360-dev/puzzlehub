# SlySwipe — Play Store listesi · Русский (`ru`)
...
**Play Console dil kodu:** `ru-RU`
**Uygulama içi locale karşılığı:** `ru` (locales/ru.js)
...
1. **Mağaza metni uygulama içi çeviriden AYRIDIR.** `locales/ru.js`
