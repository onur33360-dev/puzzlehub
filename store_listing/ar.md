# SlySwipe — Play Store listesi · العربية (`ar`)
...
**Play Console dil kodu:** `ar`
**Uygulama içi locale karşılığı:** `ar` (locales/ar.js)
...
1. **Mağaza metni uygulama içi çeviriden AYRIDIR.** `locales/ar.js`
