# SlySwipe — Play Store listesi · Bahasa Indonesia (`id`)
...
**Play Console dil kodu:** `id`
**Uygulama içi locale karşılığı:** `id` (locales/id.js)
...
1. **Mağaza metni uygulama içi çeviriden AYRIDIR.** `locales/id.js`
