# SlySwipe — Play Store listesi · 日本語 (`ja`)
...
**Play Console dil kodu:** `ja-JP`
**Uygulama içi locale karşılığı:** `ja` (locales/ja.js)
...
1. **Mağaza metni uygulama içi çeviriden AYRIDIR.** `locales/ja.js`
