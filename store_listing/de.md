# SlySwipe — Play Store listesi · Deutsch (`de`)
...
**Play Console dil kodu:** `de-DE`
**Uygulama içi locale karşılığı:** `de` (locales/de.js)
...
1. **Mağaza metni uygulama içi çeviriden AYRIDIR.** `locales/de.js`
