# SlySwipe — Play Store listesi · Polski (`pl`)
...
**Play Console dil kodu:** `pl-PL`
**Uygulama içi locale karşılığı:** `pl` (locales/pl.js)
...
1. **Mağaza metni uygulama içi çeviriden AYRIDIR.** `locales/pl.js`
