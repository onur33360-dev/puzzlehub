# SlySwipe — Play Store listesi · Italiano (`it`)
...
**Play Console dil kodu:** `it-IT`
**Uygulama içi locale karşılığı:** `it` (locales/it.js)
...
1. **Mağaza metni uygulama içi çeviriden AYRIDIR.** `locales/it.js`
